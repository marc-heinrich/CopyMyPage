...
final class TeamHelper implements DatabaseAwareInterface
{
    ...
    private function resolvePrimaryItemMeta(array $items): array
    {
        ...
        $image       = $this->getImageHelper()->toAbsoluteUrl(trim((string) ($item->image ?? $placeholder)));
    ...
    {
        return $this->getImageHelper()->toAbsoluteUrl(
            '/modules/mod_copymypage_team/images/placeholder.svg'
        );
    }
