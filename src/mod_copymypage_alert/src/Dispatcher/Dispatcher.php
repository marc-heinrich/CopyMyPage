...
namespace Joomla\Module\CopyMyPage\Alert\Site\Dispatcher;
...
/**
 * Dispatcher class for mod_copymypage_alert.
 */
class Dispatcher extends AbstractModuleDispatcher implements HelperFactoryAwareInterface
{
    ...
    /**
     * Fixed layout prefix and expected system slot for this module.
     *
     * @var string
     */
    protected string $layoutPrefix = 'alert';
     ...
     * @var string
     */
    protected string $baseLayout = 'bar';
    ...
    public function dispatch(): void
    {
        ...
        $this->populateAlertData($displayData, $layout, $baseLayout);
        ...
        $loader = static function (array $displayData, string $layout): void {
            ...
            require ModuleHelper::getLayoutPath('mod_copymypage_alert', $layout);
        };
    ...
    /**
     * Resolves the requested layout variant to an existing alert layout.
     *
    ...
    protected function resolveLayout(string $layoutVariant, string $baseLayout): string
    {
        ...
        $layoutPath = ModuleHelper::getLayoutPath('mod_copymypage_alert', $layoutVariant);
    ...
    /**
     * Add the alert layout/slot warning once per render cycle.
     *
     * @return  void
     */
    protected function queueInvalidLayoutWarning(): void
    {
        ...
        $this->warnings[] = [
            'info' => Text::_('MOD_COPYMYPAGE_ALERT'),
            'desc' => Text::sprintf('MOD_COPYMYPAGE_ALERT_ALERT_INVALID_POSITION', $modulesUrl),
        ];
    }
    ...
    protected function applyFeedback(array &$displayData): void
    {
        ...
        $notice  = \is_object($displayData['notice'] ?? null) ? $displayData['notice'] : null;
        ...
        $displayData['hint'] = LayoutHelper::render(
            ...
            [
                'messages' => [
                    [
                        'info' => Text::_('MOD_COPYMYPAGE_ALERT_HINT_INFO'),
                        'desc' => Text::_('MOD_COPYMYPAGE_ALERT_HINT_DESC'),
                    ],
                ],
            ]
        );
    ...
    /**
     * Populate alert-specific data after slot and layout validation.
     *
     * @param   array<string, mixed>  $displayData  Prepared display data.
     ...
     * @return  void
     */
    protected function populateAlertData(array &$displayData, string $layout, string $baseLayout): void
    {
        ...
        $displayData['alertHelper'] = $helper;
        $displayData['notice']      = $helper->getNotice($displayData['cfg'], $layout);
