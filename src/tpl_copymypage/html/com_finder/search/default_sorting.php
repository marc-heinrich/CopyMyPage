...
<div class="sorting cmp-finder__sorting">
    <label id="sorting_label" for="sorting_btn">
    ...
    <div class="sorting__select btn-group">
        <?php foreach ($this->sortOrderFields as $sortOrderField) : ?>
            <?php if ($sortOrderField->active) : ?>
                <button
                    id="sorting_btn"
                    class="btn btn-secondary dropdown-toggle cmp-button cmp-button--secondary"
                    type="button"
        ...
        <ul
            id="finder_sorting_list"
            class="sorting__list block dropdown-menu"
            role="listbox"
            aria-labelledby="sorting_label"
        >
            <?php foreach ($this->sortOrderFields as $sortOrderField) : ?>
                <li class="sorting__list-li<?php echo $sortOrderField->active ? ' sorting__list-li-active' : ''; ?>">
                    <a
                        class="dropdown-item"
                        role="option"
                        href="<?php echo Route::_($sortOrderField->url); ?>"
