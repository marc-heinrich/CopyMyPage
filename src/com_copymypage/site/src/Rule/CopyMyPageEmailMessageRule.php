...
/**
 * Reject configured words or phrases in the contact message.
 */
final class CopyMyPageEmailMessageRule extends FormRule
{
    /**
     * Test the message against the component's banned-text list.
     *
    ...
    public function test(
        ...
        $banned = trim(
            (string) ComponentHelper::getParams('com_copymypage')->get('banned_text', '')
        );
