...
namespace Joomla\Module\CopyMyPage\Counts\Site\Dispatcher;
...
/**
 * Dispatcher class for mod_copymypage_counts.
 */
class Dispatcher extends AbstractModuleDispatcher implements HelperFactoryAwareInterface
{
     ...
     * @var string
     */
    protected string $layoutPrefix = 'counts';
    ...
    public function dispatch(): void
    {
        ...
        $this->populateCountsData($displayData, $layout);
        ...
        $loader = static function (array $displayData, string $layout): void {
            ...
            require ModuleHelper::getLayoutPath('mod_copymypage_counts', $layout);
        };
    ...
    /**
     * Resolves the requested layout variant to an existing counts layout.
     *
    ...
    protected function resolveLayout(string $layoutVariant, string $baseLayout): string
    {
        ...
        $layoutPath = ModuleHelper::getLayoutPath('mod_copymypage_counts', $layoutVariant);
    ...
    /**
     * Add the counts layout/slot warning once per render cycle.
     *
     * @return  void
     */
    protected function queueInvalidLayoutWarning(): void
    {
        ...
        $this->warnings[] = [
            'info' => Text::_('MOD_COPYMYPAGE_COUNTS'),
            'desc' => Text::sprintf('MOD_COPYMYPAGE_COUNTS_ALERT_INVALID_POSITION', $modulesUrl),
        ];
    }
    ...
    protected function applyFeedback(array &$displayData): void
    {
        ...
        $displayData['hint'] = LayoutHelper::render(
            ...
            [
                'messages' => [
                    [
                        'info' => Text::_('MOD_COPYMYPAGE_COUNTS_HINT_INFO'),
                        'desc' => Text::_('MOD_COPYMYPAGE_COUNTS_HINT_DESC'),
                    ],
                ],
            ]
        );
    ...
    /**
     * Populate counts-specific data after slot and layout validation.
     *
     * @param   array<string, mixed>  $displayData  Prepared display data.
     ...
     * @return  void
     */
    protected function populateCountsData(array &$displayData, string $layout): void
    {
        $helper = $this->getHelperFactory()->getHelper('CountsHelper');

        $displayData['countsHelper'] = $helper;
